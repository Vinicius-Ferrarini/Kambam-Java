package to_do_atv2semestre.to_do_list.security.authentication;
...
public class JwtTokenService {
    ...
    private Instant creationDate() {
        return ZonedDateTime.now(ZoneId.of("America/Puerto_Rico")).toInstant();
    }

    private Instant expirationDate() {
        return ZonedDateTime.now(ZoneId.of("America/Puerto_Rico")).plusHours(4).toInstant();
    }
